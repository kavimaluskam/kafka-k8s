...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "kafka-broker.zookeeper.fullname" -}}
...
*/}}
{{- define "kafka-broker.zookeeper.service-name" }}
{{- if (index .Values "zookeeper" "enabled") -}}
{{- $clientPort := default 2181 (index .Values "zookeeper" "clientPort") | int -}}
{{- printf "%s:%d" (include "kafka-broker.zookeeper.fullname" .) $clientPort }}
{{- else -}}
...
*/}}
{{- define "kafka-broker.configuration.advertised.listeners" }}
...
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
*/}}
{{- define "kafka-broker.kafka-broker-headless.fullname" -}}
